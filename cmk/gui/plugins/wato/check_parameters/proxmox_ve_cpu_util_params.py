...
from cmk.gui.valuespec import Dictionary, Alternative, Tuple, Float, FixedValue, Integer
...
def _parameter_valuespec_proxmox_ve_cpu_util():
    return Dictionary(
        ...
        elements=[
                ...
                Alternative(
                    ...
                    elements=[
                        Tuple(
                            ...
                            elements=[
                                Float(minvalue=0.0, maxvalue=100.0, unit="%", default_value=90.0,
                                      title=_("Warning at")),
                                Float(minvalue=0.0, maxvalue=100.0, unit="%", default_value=95.0,
                                      title=_("Critical at")),
                            ],
                        ),
            ...
            (
                "average",
                Integer(minvalue=1, unit="minutes", title=_("Average CPU Value over"))
            ),
        ],
    )
